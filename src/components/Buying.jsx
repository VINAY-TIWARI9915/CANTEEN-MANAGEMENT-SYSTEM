...
function Buying1() {
  ...
  return (
    <div   className= "mt-5 mb-5 "style={{marginLeft:'500px', marginRight:'500px'}}>
       
<form className=' border-4 rounded-md p-5 bg-opacity-30  text-semibold'>
<h1 className='mb-10 text-semibold text-2xl flex justify-center'>BASIC DETAILS FOR ORDERING</h1>
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 justify-center">Submit</button>
</form>
</div>
  )
}
